...
const Contact = () => {
  ...
  const handelSubmit = (e) =>{
    ...
    emailjs.send(process.env.serviceId, process.env.templateId,
      {
        from_name: form.name,
        to_name: 'Shreyansh Goyal',
        from_email: form.email,
        to_email:'shreyanshgl2003@gmail.com',
        ...
        >
          ...
          <label className="flex flex-col">
            <div
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none"
            >
              <a href="https://drive.google.com/file/d/1qpMlP0cjqZ1795q9Hc7HNr-jLcX8eT6I/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>
            </div>
          </label>
          <label className="flex flex-col">
            <div
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none"
            >
              <a href="https://www.linkedin.com/in/shreyansh-goyal-11b131229/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
          </label>
          <button type="submit"
